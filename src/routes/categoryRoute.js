...
const categoryAdd = require('../modules/categoryComplement/mongooseDB/mongoAdd');
...
const category = require('../modules/categoryComplement/managment/managmentCategory');
...
categoryRouter.post('/create/', async (req, res) => {
  try {
    ...
    if (respJson.status === 200) {
      response = await categoryAdd.addCategory(jsonInfo);
